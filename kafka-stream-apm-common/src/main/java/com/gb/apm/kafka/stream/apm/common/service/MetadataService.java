 ...
 */
package com.gb.apm.kafka.stream.apm.common.service;
...
public class MetadataService {
  ...
  private final KafkaStreamApp app;
  private KafkaStreams streams;
  private HostInfo hostInfo; 

  public MetadataService(final KafkaStreamApp app,HostInfo hostInfo) {
    this.app = app;
    this.streams = this.app.streams();
    this.hostInfo = hostInfo;
  }
  
  public boolean thisHost(HostStoreInfo host) {
		return host.getHost().equals(hostInfo.host()) &&
		           host.getPort() == hostInfo.port();
  }
  
  public boolean thisHost(HostInfo host) {
	  return hostInfo.equals(host);
  }
