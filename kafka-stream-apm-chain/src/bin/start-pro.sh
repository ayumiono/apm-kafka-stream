...
nohup java -Dspring.profiles.active=pro $JVM_OPTS $JVM_PERFORMANCE_OPTS $JVM_GC_LOG_OPTS $DBLOGGER_LOG4J_OPTS -cp $CLASSPATH com.gb.apm.kafka.stream.apm.chain.boot.SpringBootApp >/dev/null 2>&1 &