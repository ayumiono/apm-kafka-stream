...
nohup java -Dspring.profiles.active=production $JVM_OPTS $JVM_PERFORMANCE_OPTS $JVM_GC_LOG_OPTS $DBLOGGER_LOG4J_OPTS -cp $CLASSPATH com.gb.apm.web.ApmWebApplication >/dev/null 2>&1 &